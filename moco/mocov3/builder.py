...
class MoCoV3(nn.Module):
    ...
    def __init__(self, base_encoder, dim=128, m=0.999, mlp=None, prediction_head=None, mlp_embedding=False,
                 spectral_normalization=False, queue_size=0, teacher=False):
        """
    ...
    def forward(self, x1, x2=None, patch1=None, patch2=None, extra_feat1=None, extra_feat2=None, patch_meta_data=None,
        ...
        if x2 is None:
            ...
            if return_patch:
                return normalizer(embedding), None
        ...
        with torch.no_grad():  # no gradient to keys
            ...
            k1, k2 = self.k_projection_head(self.encoder_k(x1)), self.k_projection_head(self.encoder_k(x2))  # keys: NxC
        ...
        return (q1, q2), (k1, k2), (None, None, None), (None, None), (
        extra_feat1, extra_feat2), None, None, None  # quantization loss is none
